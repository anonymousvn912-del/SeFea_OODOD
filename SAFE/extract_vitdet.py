...
@torch.no_grad()
def extract_pass(input_im, predictor, postprocessors, model_utils, tracker, dset_file, index, kept_rois=None, metadata=None, classname_file=None):
	# import pdb; pdb.set_trace()
	# h = input_im[0]['height']
	...
	# print('input_im[0][image]', input_im[0]['image'].shape, input_im[0]['height'], input_im[0]['width']) # input_im[0][image] torch.Size([3, 800, 1093]) 366 500
