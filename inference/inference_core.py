...
class ProbabilisticPredictor(ABC):
    ...
    def __call__(self, input_im):
        ...
        if self.inference_mode == 'standard_nms':
            results = self.post_processing_standard_nms(input_im) ### RCNN RN50 VOS 
    ...
    def visualize_inference(self, inputs, results, savedir, name, cfg, energy_threshold=None): ### eee cfg
        """
        ...
        v_pred = ProbabilisticVisualizer(img, MetadataCatalog.get(cfg.DATASETS.TRAIN[0])) # eee cfg.DATASETS.TRAIN[0]
