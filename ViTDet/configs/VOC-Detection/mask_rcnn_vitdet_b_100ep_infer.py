...
model.roi_heads.box_predictor.test_score_thresh = 0.6436 ## Run eval_vitdet.py to get this value
# Initialization and trainer settings
train = model_zoo.get_config("common/train.py").train
train.amp.enabled = True
train.ddp.fp16_compression = True
train.init_checkpoint = (
    "ViTDet/output/ViTDet/VOC-Detection/mask_rcnn_vitdet_b_100ep/model_final.pth"
    # "detectron2://ImageNetPretrained/MAE/mae_pretrain_vit_base.pth?matching_heuristics=True"
)
train.output_dir="ViTDet/output/ViTDet/VOC-Detection/mask_rcnn_vitdet_b_100ep/infer_50k"
