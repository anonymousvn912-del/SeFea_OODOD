...
# V1 Subset Encoder + Subset Decoder + SAFE
hook_names_v1 = [
...
hook_index_v4 = {
    's_cnn_hook_idx' : hook_names_v4.index('backbone.0.body.layer1.0.downsample'),
    'e_cnn_hook_idx' : hook_names_v4.index('backbone.0.body.layer4.0.downsample'),
    's_tra_enc_hook_idx' : hook_names_v4.index('transformer.encoder.layers.0.self_attn.value_proj'),
    'e_tra_enc_hook_idx' : hook_names_v4.index('transformer.encoder.layers.5.norm2'),
    's_tra_dec_hook_idx' : hook_names_v4.index('transformer.decoder.layers.0.norm1'),
    'e_tra_dec_hook_idx' : hook_names_v4.index('transformer.decoder.layers.5.norm3')
}


# V5 Input
hook_names_v5 = []
hook_names_v5.extend(collect_in_out_hook_names(['backbone.0.body.conv1']))

hook_index_v5 = {
    's_cnn_hook_idx' : hook_names_v5.index('backbone.0.body.conv1_in'),
    'e_cnn_hook_idx' : hook_names_v5.index('backbone.0.body.conv1_out'),
}
...
elif hook_version == 'v4':
    hook_names = hook_names_v4
    hook_index = hook_index_v4
...
elif hook_version == 'v5':
    hook_names = hook_names_v5
    hook_index = hook_index_v5

elif hook_version == 'v6':
    hook_names = hook_names_v6
    hook_index = hook_index_v6

elif hook_version == 'v7':
    hook_names = hook_names_v7
    hook_index = hook_index_v7
