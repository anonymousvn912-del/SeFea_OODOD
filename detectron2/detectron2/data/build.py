...
def get_detection_dataset_dicts(
    ...
    """
    # print('names:', names) # names: ['voc_custom_train']
    # print('filter_empty:', filter_empty) # filter_empty: False
    # print('min_keypoints:', min_keypoints) # min_keypoints: 0
    # print('proposal_files:', proposal_files) # proposal_files: None
    # print('check_consistency:', check_consistency) # check_consistency: True
    ...
    # print('name ', names, DatasetCatalog.keys())
    
    dataset_dicts = [DatasetCatalog.get(dataset_name) for dataset_name in names]
    # print(type(dataset_dicts), len(dataset_dicts), type(dataset_dicts[0]), len(dataset_dicts[0])) # <class 'list'> 1 <class 'list'> 16551
...
def build_batch_data_loader(
    ...
    **kwargs,
    ...
    if isinstance(dataset, torchdata.IterableDataset):
        ...
        # <class 'detectron2.data.common.MapDataset'> 117266
        # <class 'detectron2.data.samplers.distributed_sampler.InferenceSampler'>
        # print('type(dataset)' * 5, type(dataset), len(dataset))
        # print('type(sampler)' * 5, type(sampler))
        # exit()
    ...
    if aspect_ratio_grouping:
        ...
        # <class 'torch.utils.data.dataloader.DataLoader'> 1
        # print('type(data_loader)' * 5, type(data_loader), batch_size)
        data_loader = AspectRatioGroupedDataset(data_loader, batch_size)
        # <class 'detectron2.data.common.AspectRatioGroupedDataset'> 1
        # print('type(data_loader) 1' * 5, type(data_loader), batch_size)
...
def _train_loader_from_config(cfg, mapper=None, *, dataset=None, sampler=None):
    # mapper None
    # dataset None
    # sampler <detectron2.data.samplers.distributed_sampler.InferenceSampler object at 0x7fb06156f1d0>
    # print('mapper', mapper)
    # print('dataset', dataset)
    # print('sampler', sampler)
    if dataset is None:
        # cfg.DATASETS.TRAIN ('voc_custom_train',)
...
def build_detection_test_loader(
    ...
    *,
    ...
    """
    ### for VOC: dataset: <class 'list'> 16551
    if isinstance(dataset, list):
        dataset = DatasetFromList(dataset, copy=False)
    if mapper is not None:
        dataset = MapDataset(dataset, mapper)
