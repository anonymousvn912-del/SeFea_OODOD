...
class ToIterableDataset(data.IterableDataset):
    ...
    def __iter__(self):
        ...
        # <class 'generator'>
        # 117266
        # print('len(self.sampler)' * 5, len(self.sampler), type(self.sampler))
        # print('type(sampler)' * 5, type(sampler))
        # print('self.shard_chunk_size' * 5, self.shard_chunk_size)
        # print('self.dataset' * 5, len(self.dataset))
        for idx in sampler:
...
class AspectRatioGroupedDataset(data.IterableDataset):
    ...
    def __iter__(self):
        # 118287 <class 'torch.utils.data.dataloader.DataLoader'>
        # print('len(self.dataset)' * 5, len(self.dataset), type(self.dataset))
