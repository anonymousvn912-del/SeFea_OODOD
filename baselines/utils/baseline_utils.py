...
def get_msp_score_for_ms_detr():
    MSP_scores_folder = '/home/khoadv/SAFE/SAFE_Official/baselines/MSP'
    MSP_fpr95_threshold = {}
    ...
    voc = general_purpose.load_pickle(os.path.join(MSP_scores_folder, 'msp_scores_VOC_MS_DETR_voc_custom_val.pkl'))
    voc_coco = general_purpose.load_pickle(os.path.join(MSP_scores_folder, 'msp_scores_VOC_MS_DETR_coco_ood_val.pkl'))
    voc_openimages = general_purpose.load_pickle(os.path.join(MSP_scores_folder, 'msp_scores_VOC_MS_DETR_openimages_ood_val.pkl'))
    ...
    print(f'ID: VOC, OOD: VOC-COCO, auroc: {auroc}, fpr: {fpr}, fpr95_threshold: {fpr95_threshold}')
    MSP_fpr95_threshold['VOC_COCO'] = fpr95_threshold
    auroc, aupr, fpr, fpr95_threshold = get_custom_scores(voc_positive, voc_openimages_negative)
    print(f'ID: VOC, OOD: VOC-OPENIMAGES, auroc: {auroc}, fpr: {fpr}, fpr95_threshold: {fpr95_threshold}')
    MSP_fpr95_threshold['VOC_OpenImages'] = fpr95_threshold
    
    bdd = general_purpose.load_pickle(os.path.join(MSP_scores_folder, 'msp_scores_BDD_MS_DETR_bdd_custom_val.pkl'))
    bdd_coco = general_purpose.load_pickle(os.path.join(MSP_scores_folder, 'msp_scores_BDD_MS_DETR_coco_ood_val.pkl'))
    bdd_openimages = general_purpose.load_pickle(os.path.join(MSP_scores_folder, 'msp_scores_BDD_MS_DETR_openimages_ood_val.pkl'))
    ...
    print(f'ID: BDD, OOD: BDD-COCO, auroc: {auroc}, fpr: {fpr}, fpr95_threshold: {fpr95_threshold}')
    MSP_fpr95_threshold['BDD_COCO'] = fpr95_threshold
    auroc, aupr, fpr, fpr95_threshold = get_custom_scores(bdd_positive, bdd_openimages_negative)
    print(f'ID: BDD, OOD: BDD-OPENIMAGES, auroc: {auroc}, fpr: {fpr}, fpr95_threshold: {fpr95_threshold}')
    MSP_fpr95_threshold['BDD_OpenImages'] = fpr95_threshold
    
    general_purpose.save_pickle(MSP_fpr95_threshold, os.path.join(MSP_scores_folder, 'MSP_fpr95_threshold.pkl'))
